-- Flyway baseline schema for SeedanceGenarate.
-- This file represents the current consolidated schema that used to be maintained in schema.sql.
...
CREATE TABLE video_task (
    ...
    provider VARCHAR(32) NOT NULL DEFAULT 'seedance',
    node_id VARCHAR(64),
    api_key_id BIGINT NULL COMMENT '对外 API 来源判别列；空=UI',
    model VARCHAR(64),
    ...
    INDEX idx_video_task_status_time (status, create_time),
    INDEX idx_video_task_user_update (user_id, update_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE api_call_log (
    ...
    INDEX idx_call_log_status_time (status, create_time)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户素材文件夹';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户素材库';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='分镜流水线';
...
CREATE TABLE pipeline_node (
    ...
    KEY idx_node_task_id (task_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='流水线节点';
