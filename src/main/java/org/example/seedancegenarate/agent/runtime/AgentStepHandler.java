...
public class AgentStepHandler implements AsyncJobHandler {
    private final AgentRuntime runtime;
    public String jobType() { return AgentRuntime.STEP_JOB; }
    ...
    public void execute(AsyncJob lease) { runtime.execute(lease,false); }
}
