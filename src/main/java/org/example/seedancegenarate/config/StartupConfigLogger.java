...
public class StartupConfigLogger {
    ...
    private static final List<String> KEYS = List.of(
            ...
            // 在途并发额度：shadow=true 时只记日志不拒绝，排查「为什么没拦住」的第一问
            "concurrency.enabled",
            "concurrency.shadow",
            "concurrency.redis-key-prefix",
            "concurrency.avg-task-minutes",
            "concurrency.derive-api-rate-limit",
            ...
            "video.comfyui.probe-interval-ms",
            "video.comfyui.pending-aging-ms",
            "video.comfyui.unhealthy-after-failures",
            "video.comfyui.capability-probe-interval-ms",
            "video.comfyui.probe-backoff-max-ms",
